...
const rawSteps: (Omit<Step, 'cx' | 'cy' | 'r'> & { _r: number; _cx: number; _cy: number })[] = [
  ...
  { id:'D1', label:'Competitive\nAlternatives Audit', phase:'positioning', _r:44, _cx:600, _cy:370, source:'Positioning Framework', detail:'Identify what customers are actually doing instead of using this product/service. Foundation of all positioning work.' },
  ...
  { id:'ODI1', label:'Define\nJob Performer', phase:'odi', _r:36, _cx:600, _cy:600, source:'Strategic Decision System — Phase 1', detail:'Explicitly define WHO performs the core job. Distinguish the job performer from the buyer, influencer, and end beneficiary.' },
  { id:'ODI2', label:'Core Functional\nJob Statement', phase:'odi', _r:40, _cx:600, _cy:710, source:'Strategic Decision System — Phase 1', detail:'Write the core functional job as: Verb + Object of Control + Clarifier. Must be solution-agnostic and stable over time.' },
  { id:'ODI3', label:'Build Job Map\n(8-12 Steps)', phase:'odi', _r:48, _cx:600, _cy:830, source:'Strategic Decision System — Phase 2', detail:'Deconstruct the core job into 8-12 universal job steps: Define → Locate → Prepare → Confirm → Execute → Monitor → Modify → Conclude.' },
  { id:'ODI4', label:'Consumption Chain\n+ Emotional Jobs', phase:'odi', _r:40, _cx:600, _cy:950, source:'Strategic Decision System — Phase 3', detail:'Identify all related jobs beyond the core functional job including Purchase, Learn-to-use, Maintain, Repair, and Dispose jobs. Also Emotional and Social jobs.' },
  { id:'D2', label:'Winning\nAspiration', phase:'cascade', _r:40, _cx:600, _cy:1060, source:'Strategy Cascade', detail:'Define what "winning" looks like for this organization. A specific, inspiring picture of success.' },
  { id:'D3', label:'Bright Spots\nAnalysis', phase:'diagnosis', _r:36, _cx:600, _cy:1165, source:'Change Design', detail:'Find what is already working. Identify the bright spots and understand why, so they can be amplified.' },
  { id:'D5', label:'Hero + Problem\nDefinition', phase:'messaging', _r:42, _cx:600, _cy:1275, source:'Narrative Framework', detail:'Define the Hero (customer) and the 3-level Problem: External, Internal, and Philosophical.' },
  ...
  { id:'8a', label:'Transcript →\nNeeds Capture', phase:'odi', _r:44, _cx:800, _cy:1820, source:'Core Workflow + Strategic Decision System', detail:'Transcript processed to capture raw needs, wants, and desires for Strategic Decision System outcome statements.' },
  { id:'D6', label:'Six Questions\nDecision Audit', phase:'diagnosis', _r:34, _cx:400, _cy:1820, source:'Change Design', detail:'Run initial findings through the Six Questions framework to surface hidden assumptions.' },
  ...
  { id:'D7', label:'Where to Play\n& How to Win', phase:'cascade', _r:50, _cx:600, _cy:2505, source:'Strategy Cascade', detail:'Define the two most critical strategic choices: Where to Play and How to Win.' },
  { id:13, label:'Stakeholder &\nCustomer Interviews', phase:'diagnosis', _r:56, _cx:600, _cy:2645, source:'Core Workflow + Continuous Discovery', detail:'MOST SIGNIFICANT STEP: Structured interviews with key internal stakeholders and external customers.' },
  { id:'ODI5', label:'Capture Outcome\nStatements', phase:'odi', _r:52, _cx:600, _cy:2785, source:'Strategic Decision System — Phase 4', detail:'Convert all raw needs from interviews into properly formatted outcome statements.' },
  { id:'ODI6', label:'Organize + Validate\nOutcomes', phase:'odi', _r:44, _cx:600, _cy:2910, source:'Strategic Decision System — Phase 5', detail:'Group outcome statements by job step. Remove duplicates. Validate solution-agnosticism.' },
  { id:'ODI7', label:'Outcome Statement\nValidation Workshop', phase:'odi', _r:42, _cx:600, _cy:3030, source:'Strategic Decision System', detail:'Internal workshop to review, challenge, and finalize the outcome statement list.' },
  { id:'D8', label:'Unique Attributes\nIsolation', phase:'positioning', _r:44, _cx:600, _cy:3150, source:'Positioning Framework', detail:'Isolate the unique attributes and capabilities that competitors cannot easily replicate.' },
  { id:'ODI8', label:'Design Outcome\nSurvey (Imp + Sat)', phase:'odi', _r:46, _cx:600, _cy:3270, source:'Strategic Decision System — Phase 6', detail:'Build the outcome survey. Each outcome rated on Importance and Satisfaction. Min 180 respondents.' },
  { id:14, label:'Create & Distribute\nOutcome Survey', phase:'diagnosis', _r:40, _cx:600, _cy:3385, source:'Core Workflow + Strategic Decision System', detail:'Outcome survey finalized and distributed to the target population.' },
  ...
  { id:'ODI9', label:'Calculate\nOpportunity Scores', phase:'odi', _r:48, _cx:600, _cy:3680, source:'Strategic Decision System — Phase 8', detail:'Apply the Opportunity Score formula. Scores range 0-20. Above 10 = high-opportunity.' },
  { id:'ODI10', label:'Segment Market\nby Outcomes', phase:'odi', _r:50, _cx:600, _cy:3810, source:'Strategic Decision System — Phase 9', detail:'Use outcome data to find natural customer segments with unique underserved outcomes.' },
  { id:'ODI11', label:'Opportunity\nLandscape Map', phase:'odi', _r:48, _cx:600, _cy:3940, source:'Strategic Decision System — Phase 10', detail:'Plot all outcomes on a 2x2 matrix of Importance vs. Satisfaction.' },
  { id:15, label:'Analyze Survey Data\n+ Update Map', phase:'focus', _r:48, _cx:600, _cy:4070, source:'Core Workflow + Strategic Decision System', detail:'All opportunity scores, segments, and opportunity landscape data integrated into the Mojo Map.' },
  { id:'ODI12', label:'Select\nInnovation Strategy', phase:'odi', _r:46, _cx:600, _cy:4195, source:'Strategic Decision System — Phase 10', detail:'Choose the innovation strategy: Differentiated, Dominant, Disruptive, or Discrete.' },
  { id:'F1', label:'Strategic Options\n+ What Must Be True', phase:'focus', _r:54, _cx:600, _cy:4330, source:'Strategy Testing', detail:'Generate 2-4 distinct strategic options. List conditions that must be true for each to succeed.' },
  { id:'F2', label:'Capabilities &\nSystems Audit', phase:'cascade', _r:46, _cx:600, _cy:4460, source:'Strategy Cascade', detail:'Audit the capabilities and management systems needed to execute the chosen strategy.' },
  { id:'F3', label:'Assumption\nMapping', phase:'focus', _r:42, _cx:600, _cy:4580, source:'Continuous Discovery', detail:'Map all underlying assumptions. Categorize by desirability, viability, and feasibility.' },
  { id:'ODI13', label:'Generate\nSolution Concepts', phase:'odi', _r:48, _cx:600, _cy:4705, source:'Strategic Decision System — Phase 10', detail:'Generate solution concepts addressing the highest-opportunity outcomes.' },
  { id:'F4', label:'Market Frame\nof Reference', phase:'positioning', _r:40, _cx:600, _cy:4825, source:'Positioning Framework', detail:'Decide which market category to compete in. Sets customer expectations.' },
  { id:'F5', label:'Critical Moves\n& Destination', phase:'focus', _r:44, _cx:600, _cy:4940, source:'Change Design', detail:'Script the 1-3 specific behavior changes required. Create a vivid destination postcard.' },
  { id:'F6', label:'STEPPS\nVirality Audit', phase:'focus', _r:42, _cx:600, _cy:5055, source:'Growth Design', detail:'Audit through the STEPPS lens: Social Currency, Triggers, Emotion, Public, Practical Value, Stories.' },
  { id:'F7', label:'Sticky Message\nAudit (SUCCESs)', phase:'messaging', _r:40, _cx:600, _cy:5170, source:'Messaging Design', detail:'Audit: Simple? Unexpected? Concrete? Credible? Emotional? Story?' },
  { id:16, label:'Prioritization\nWorkshop', phase:'focus', _r:54, _cx:600, _cy:5300, source:'Core Workflow', detail:'Facilitated workshop to synthesize all opportunity scores, strategic options, and What Must Be True analysis.' },
  { id:'ODI14', label:'Validate\nSolution Concepts', phase:'odi', _r:44, _cx:600, _cy:5425, source:'Strategic Decision System', detail:'Test solution concepts with the target segment to confirm they address unmet outcomes.' },
  { id:'F8', label:'Positioning\nStatement Draft', phase:'positioning', _r:46, _cx:600, _cy:5550, source:'Positioning Framework', detail:'Draft the formal positioning statement grounded in validated outcome data.' },
  { id:17, label:'Final Synthesis:\nOpportunity Map', phase:'focus', _r:58, _cx:600, _cy:5690, source:'Core Workflow + Strategic Decision System + Continuous Discovery', detail:'MOST COMPLEX STEP: All data synthesized into the complete Opportunity/Solution Map.' },
  { id:'F9', label:'Strategy Cascade\nCoherence Check', phase:'cascade', _r:44, _cx:600, _cy:5830, source:'Strategy Cascade', detail:'Validate that all 5 strategic choices reinforce each other.' },
  { id:'L1', label:'BrandScript\n& Messaging Guide', phase:'messaging', _r:50, _cx:600, _cy:5970, source:'Narrative Framework', detail:'Build the full BrandScript: Hero, Problem, Guide, Plan, Call to Action, Failure, Success.' },
  ...
  { id:'L2', label:'Internal Positioning\nSocialization', phase:'positioning', _r:38, _cx:600, _cy:6225, source:'Positioning Framework', detail:'Facilitate internal workshops to socialize the new positioning across the organization.' },
  { id:'L3', label:'Apply Messaging\nto Website + Comms', phase:'messaging', _r:44, _cx:600, _cy:6345, source:'Narrative Framework', detail:'Apply the BrandScript to the website header, one-liner, lead generator, and email nurture sequence.' },
  { id:'L4', label:'Experiment Design\n& WMBT Tests', phase:'flow', _r:46, _cx:600, _cy:6470, source:'Continuous Discovery + Strategy', detail:'Design the smallest possible tests to validate the most fragile assumptions.' },
  { id:'L5', label:'Small Wins\n& Habit Design', phase:'flow', _r:38, _cx:600, _cy:6580, source:'Change Design', detail:'Break the strategic goal into small wins that generate momentum.' },
  ...
  { id:'L6', label:'Weekly Customer\nInterview Cadence', phase:'flow', _r:40, _cx:600, _cy:6800, source:'Continuous Discovery', detail:'Establish an ongoing weekly cadence of at least one customer interview per week.' },
  { id:'L7', label:'Build-Measure\n-Learn Loop', phase:'flow', _r:42, _cx:600, _cy:6915, source:'Continuous Discovery', detail:'Establish the continuous discovery loop: Build, Measure, Learn.' },
...
/* ── Phase colors — warm palette matching MapViewAlt ── */
...
const phaseLabels: Record<string, string> = {
  ...
  cascade: 'Strategy Cascade', messaging: 'Messaging', odi: 'Strategic Decision System',
};
        ...
        <div className="overflow-hidden mb-6" style={cardStyle}>
          <div className="p-6 sm:p-8">
            ...
            <p className="font-sans text-[14px] leading-[1.65] mt-2 max-w-xl" style={{ color: c.secondary }}>
              All steps across Diagnosis · Focus · Flow — including the full Strategic Decision System process. Hover any circle for details.
            </p>
          </div>
        </div>
