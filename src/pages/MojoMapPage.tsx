...
const rawSteps: (Omit<Step, 'cx' | 'cy' | 'r'> & { _r: number; _cx: number; _cy: number })[] = [
  ...
  { id:'SDS1', label:'Define\nJob Performer', phase:'odi', _r:36, _cx:600, _cy:600, source:'Strategic Decision System — Tony Ulwick (Step 1)', detail:'Explicitly define WHO performs the core job. Distinguish the job performer from the buyer, influencer, and end beneficiary.' },
  { id:'SDS2', label:'Core Functional\nJob Statement', phase:'odi', _r:40, _cx:600, _cy:710, source:'Strategic Decision System — Tony Ulwick (Step 1)', detail:'Write the core functional job as: Verb + Object of Control + Clarifier. Must be solution-agnostic and stable over time.' },
  { id:'SDS3', label:'Build Job Map\n(8-12 Steps)', phase:'odi', _r:48, _cx:600, _cy:830, source:'Strategic Decision System — Tony Ulwick (Step 2)', detail:'Deconstruct the core job into 8-12 universal job steps: Define → Locate → Prepare → Confirm → Execute → Monitor → Modify → Conclude.' },
  { id:'SDS4', label:'Consumption Chain\n+ Emotional Jobs', phase:'odi', _r:40, _cx:600, _cy:950, source:'Strategic Decision System — Tony Ulwick (Step 3)', detail:'Identify all related jobs beyond the core functional job including Purchase, Learn-to-use, Maintain, Repair, and Dispose jobs. Also Emotional and Social jobs.' },
  ...
  { id:'8a', label:'Transcript →\nSDS Needs Capture', phase:'odi', _r:44, _cx:800, _cy:1820, source:'Core Workflow + Strategic Decision System', detail:'Transcript processed to capture raw needs, wants, and desires for Strategic Decision System outcome statements.' },
  ...
  { id:'SDS5', label:'Capture Outcome\nStatements', phase:'odi', _r:52, _cx:600, _cy:2785, source:'Strategic Decision System — Tony Ulwick (Step 4)', detail:'Convert all raw needs from interviews into properly formatted outcome statements.' },
  { id:'SDS6', label:'Organize + Validate\nOutcomes', phase:'odi', _r:44, _cx:600, _cy:2910, source:'Strategic Decision System — Tony Ulwick (Step 5)', detail:'Group outcome statements by job step. Remove duplicates. Validate solution-agnosticism.' },
  { id:'SDS7', label:'Outcome Statement\nValidation Workshop', phase:'odi', _r:42, _cx:600, _cy:3030, source:'Strategic Decision System — Internal Quality Gate', detail:'Internal workshop to review, challenge, and finalize the outcome statement list.' },
  ...
  { id:'SDS8', label:'Design SDS Survey\n(Imp + Sat)', phase:'odi', _r:46, _cx:600, _cy:3270, source:'Strategic Decision System — Tony Ulwick (Step 6)', detail:'Build the Strategic Decision System survey. Each outcome rated on Importance and Satisfaction. Min 180 respondents.' },
  { id:14, label:'Create & Distribute\nSDS Survey', phase:'diagnosis', _r:40, _cx:600, _cy:3385, source:'Core Workflow + Strategic Decision System', detail:'Strategic Decision System survey finalized and distributed to the target population.' },
  ...
  { id:'SDS9', label:'Calculate\nOpp Scores', phase:'odi', _r:48, _cx:600, _cy:3680, source:'Strategic Decision System — Tony Ulwick (Step 8)', detail:'Apply the Ulwick Opp Score formula. Scores range 0-20. Above 10 = high-opportunity.' },
  { id:'SDS10', label:'Segment Market\nby Outcomes', phase:'odi', _r:50, _cx:600, _cy:3810, source:'Strategic Decision System — Tony Ulwick (Step 9)', detail:'Use outcome data to find natural customer segments with unique underserved outcomes.' },
  { id:'SDS11', label:'Opportunity\nLandscape Map', phase:'odi', _r:48, _cx:600, _cy:3940, source:'Strategic Decision System — Tony Ulwick (Step 10)', detail:'Plot all outcomes on a 2x2 matrix of Importance vs. Satisfaction.' },
  { id:15, label:'Analyze Survey Data\n+ Update Map', phase:'focus', _r:48, _cx:600, _cy:4070, source:'Core Workflow + Strategic Decision System', detail:'All Strategic Decision System scores, segments, and opportunity landscape data integrated into the Mojo Map.' },
  { id:'SDS12', label:'Select\nInnovation Strategy', phase:'odi', _r:46, _cx:600, _cy:4195, source:'Strategic Decision System — Tony Ulwick (Step 10)', detail:'Choose the innovation strategy: Differentiated, Dominant, Disruptive, or Discrete.' },
  ...
  { id:'SDS13', label:'Generate\nSolution Concepts', phase:'odi', _r:48, _cx:600, _cy:4705, source:'Strategic Decision System — Tony Ulwick (Step 10)', detail:'Generate solution concepts addressing the highest-opportunity outcomes.' },
  ...
  { id:16, label:'Prioritization\nWorkshop', phase:'focus', _r:54, _cx:600, _cy:5300, source:'Core Workflow', detail:'Facilitated workshop to synthesize all Strategic Decision System scores, strategic options, and WMBT analysis.' },
  { id:'SDS14', label:'Validate\nSolution Concepts', phase:'odi', _r:44, _cx:600, _cy:5425, source:'Strategic Decision System — Tony Ulwick', detail:'Test solution concepts with the target segment to confirm they address unmet outcomes.' },
  { id:'F8', label:'Positioning\nStatement Draft', phase:'positioning', _r:46, _cx:600, _cy:5550, source:'April Dunford — Obviously Awesome', detail:'Draft the formal positioning statement grounded in validated Strategic Decision System outcomes.' },
  { id:17, label:'Final Synthesis:\nOpportunity Map', phase:'focus', _r:58, _cx:600, _cy:5690, source:'Core Workflow + Strategic Decision System + Torres CDH', detail:'MOST COMPLEX STEP: All data synthesized into the complete Opportunity/Solution Map.' },
...
const connections: [string | number, string | number][] = [
  [1,2],[2,3],[3,'D1'],['D1',4],[4,'SDS1'],['SDS1','SDS2'],['SDS2','SDS3'],['SDS3','SDS4'],
  ['SDS4','D2'],['D2','D3'],['D3','D5'],['D5',5],[5,6],[6,'G1'],
  ['G1',7],['G1',8],
  [7,'D6'],[8,'8a'],
  ['D6',9],['8a',9],
  [9,'G2'],['G2',10],['G2','10b'],
  [10,11],['10b',11],
  [11,12],[12,'D7'],['D7',13],[13,'SDS5'],['SDS5','SDS6'],['SDS6','SDS7'],['SDS7','D8'],
  ['D8','SDS8'],['SDS8',14],[14,'14c'],['14c','G3'],
  ['G3','SDS9'],['SDS9','SDS10'],['SDS10','SDS11'],['SDS11',15],[15,'SDS12'],
  ['SDS12','F1'],['F1','F2'],['F2','F3'],['F3','SDS13'],['SDS13','F4'],['F4','F5'],['F5','F6'],['F6','F7'],['F7',16],
  [16,'SDS14'],['SDS14','F8'],['F8',17],[17,'F9'],
...
const phaseLabels: Record<string, string> = {
  ...
  cascade: 'Strategy Cascade', messaging: 'Messaging', odi: 'SDS Process',
};
