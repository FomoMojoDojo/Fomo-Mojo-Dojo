...
const rawSteps: (Omit<Step, 'cx' | 'cy' | 'r'> & { _r: number; _cx: number; _cy: number })[] = [
  ...
  { id:'ODI9', label:'Calculate\nOpp Scores', phase:'odi', _r:48, _cx:600, _cy:3680, source:'ODI — Tony Ulwick (Step 8)', detail:'Apply the Ulwick Opp Score formula. Scores range 0-20. Above 10 = high-opportunity.' },
