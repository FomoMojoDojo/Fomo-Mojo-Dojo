...
function normalizeManagedOutcomeRow(row: ManagedOutcomeRow): ManagedOutcome {
  ...
  return {
    id: row.id,
    journey_key: row.journey_key,
    outcome_title: humanizeOutcomeLanguage(row.outcome_title || composed.outcome_statement),
    outcome_statement: humanizeOutcomeLanguage(row.outcome_statement || composed.outcome_statement),
    leading_indicator: humanizeOutcomeLanguage(row.leading_indicator || composed.leading_indicator),
    target_direction: normalizeDesiredOutcomeDirection(row.target_direction || composed.target_direction),
