...
describe("interview parser rules — signed 2026-09-22, version moved three times on 2026-09-23 (4a R6, 4c R10, 4d R7)", () => {
  it("the version is stamped and is the one the migration writes", () => {
    ...
    expect(PARSER_RULES_VERSION).toBe("2026-09-23.3");
  });
