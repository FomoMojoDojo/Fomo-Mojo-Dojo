CREATE TABLE IF NOT EXISTS public.public_baseline_runs (
...
CREATE INDEX IF NOT EXISTS idx_public_baseline_runs_company_id
  ON public.public_baseline_runs(company_id);

CREATE INDEX IF NOT EXISTS idx_public_baseline_runs_created_at
  ON public.public_baseline_runs(created_at DESC);
